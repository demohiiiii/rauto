...
let cachedSavedConnectionDetails = new Map();
...
let cachedTxBlockTemplateNames = [];
let cachedTxBlockTemplateMetas = [];
let cachedTxWorkflowTemplateNames = [];
let cachedTxWorkflowTemplateMetas = [];
...
let taskOutcomeFilter = "all";
let taskRecordingFilter = "all";
let taskErrorFilter = "all";
let taskSearchQuery = "";
let taskTimeRangeFilter = "all";
...
let txWorkflowEditingBlockId = "";
let txWorkflowEditorModalOpen = false;
let suppressTxWorkflowEditorSync = false;
