const i18nEn = {
  ...
  "connectionWorkspaceSubtitle": "Use a saved connection or override the current execution target inline.",
  "connectionWorkspaceSubtitleManage": "Search, create, and update reusable saved connections here.",
  "connectionWorkspaceSubtitleTemporary": "Use this form to create/update saved connections, or apply as a session-only temporary target.",
  ...
  "sidebarConnectionTemporaryPrompt": "Temporary target mode is open. Fill in host, username, password, and profile, then apply it for this browser session.",
  ...
  "connectionTempHint": "Fill host, username, password, and profile here, then apply it as a temporary execution target.",
  ...
  "connectionPickerEmpty": "No items selected yet",
  "connectionPickerNoMatch": "No matching options",
  "connectionPickerRemoveItem": "Remove item",
  "connectionLabelsAddCustom": "Add label",
  "connectionVarsEmpty": "No variables yet. Add rows when this connection needs custom vars.",
  ...
  "savedConnEditHint": "Edit the selected connection, run profile autodetect, and choose whether to replace the saved profile.",
  ...
  "savedConnAutodetectMatched": "Detected profile already matches the current saved profile",
  "savedConnAutodetectReplaced": "Saved connection profile replaced",
  "savedConnAutodetectMissing": "Run profile autodetect first, then choose whether to replace the saved profile.",
  "close": "Close",
  "cancel": "Cancel",
  "newBtn": "New",
  ...
  "agentAuthHint": "Managed agent mode requires this token for browser API requests.",
  ...
  "agentAuthRequired": "Managed agent mode requires an API token before browser actions can call protected APIs.",
  ...
  "invalidModeHint": "Choose one of the available modes, or leave the field empty to use the default.",
  "recordFabTitle": "Recording",
  "recordLevelLabel": "Record",
  "recordDrawerClose": "Close",
  "recordDrawerSubtitle": "Every execution is recorded. Choose audit-only or full detail.",
  ...
  "txBlockDirectHint": "Edit and run a raw tx block JSON document, aligned with CLI input.",
  "txBlockDirectVarsPlaceholder": "tx block vars JSON (optional), e.g. {\"peer_host\":\"edge94.host\"}",
  "txBlockDirectVarsHint": "Optional runtime vars for direct tx block rendering. Supports connection aliases and current connection fallback lookups.",
  ...
  "txBlockTemplateRunHint": "Load a saved tx block JSON template, edit it below, then execute it with runtime vars.",
  "txBlockJsonHint": "Use the same raw tx block JSON shape as CLI. Templates also render to this exact JSON structure before execution.",
  "txBlockJsonPlaceholder": "{\"name\":\"tx-block\",\"rollback_policy\":\"none\",\"steps\":[{\"run\":{\"kind\":\"command\",\"mode\":\"User\",\"command\":\"show version\",\"timeout\":30},\"rollback\":null,\"rollback_on_failure\":false}],\"fail_fast\":true}",
  "txBlockTemplateVarsPlaceholder": "tx block template vars JSON (optional), e.g. {\"peer_host\":\"edge94.host\"}",
  ...
  "txStageHintOrchestrate": "Step 3: validate and execute a multi-device orchestration plan.",
  ...
  "txWorkflowEditorBridgeRunKindUnsupported": "workflow block editing currently supports command tx block only",
  ...
  "txWorkflowBlockTemplateVarsPlaceholder": "tx block template vars JSON (optional), e.g. {\"peer\":\"edge94\"}",
  "txWorkflowBlockTemplateVarsInvalid": "tx block template vars must be a JSON object",
  ...
  "txWorkflowBlockRollbacksPlaceholder": "rollback commands (one per line, used by per_step)",
  ...
  "txWorkflowVarsPlaceholder": "workflow vars JSON (optional), e.g. {\"peer_host\":\"edge94.host\"}",
  "txWorkflowVarsHint": "Supports direct cross-connection refs like edge94.host. Plain keys fallback to current target connection params.",
  ...
  "txWorkflowTemplateRefHint": "This block references a tx block template and will be expanded at runtime.",
  ...
  "txWorkflowLoadUnsupportedTemplateContent": "workflow builder backfill currently supports tx_block_template_name only",
  "txWorkflowLoadUnsupportedOperation": "workflow builder JSON backfill currently supports command-only steps and rollback operations",
  "txWorkflowTemplateRunTitle": "Workflow Template",
  "txWorkflowTemplateLoadBtn": "Apply To JSON",
  "txWorkflowDirectHint": "Use the workflow editor form below for direct workflow execution.",
  "txWorkflowTemplateRunHint": "Select a saved workflow template and execute it directly with runtime vars.",
  ...
  "orchestrationTemplateRunHint": "Select a saved orchestration template and execute it directly with runtime vars.",
  "orchestrationTemplateEditHint": "You can edit the loaded orchestration plan in the JSON editor below before preview/execute.",
  "orchestrationDirectHint": "Use the orchestration plan JSON for direct execution.",
  "orchestrationEditorTitle": "Orchestration JSON",
  "orchestrationJsonHint": "Edit the raw orchestration plan JSON. Template execution also uses this same editor for preview and adjustments.",
  "orchestrationBaseDirPlaceholder": "base dir for inventory/workflow relative paths (optional)",
  "orchestrationVarsPlaceholder": "plan vars JSON (optional), e.g. {\"peer_host\":\"edge94.host\"}",
  "orchestrationVarsHint": "Template strings can use {{ peer_host }} (vars + fallback) or direct {{ edge94.host }}.",
  "orchestrationJsonPlaceholder": "{\"name\":\"campus-rollout\",\"stages\":[{\"name\":\"phase-1\",\"strategy\":\"parallel\",\"jobs\":[]}],\"inventory_file\":\"./inventory.json\"}",
  ...
  "orchestrationCommandPreviewEmpty": "No command details available for this stage preview.",
  ...
  "orchestrationPayloadKey": "Key",
  "orchestrationPayloadValue": "Value",
  ...
  "backupRestoreConfirmMerge": "Restore backup to ~/.rauto in merge mode now? Existing files may be overwritten.",
  "backupRestoreConfirmReplace": "Restore backup to ~/.rauto in replace mode now? Current ~/.rauto data will be replaced.",
  ...
  "templateUseBtn": "Open",
  "flowHint": "Use a saved or built-in command flow template for wizard-style CLI interactions. Variables are optional and will be merged into the template render context.",
  ...
  "flowVarsJsonHint": "Use JSON for advanced overrides. Reference values support connection.param or plain param fallback lookup.",
  ...
  "flowBuiltinTemplateHint": "Load built-in flow template TOML here, then copy it to custom editor for further editing and saving.",
  ...
  "flowBuiltinTemplateNameRequired": "built-in command flow template name is required",
  "flowBuiltinTemplateCopyPrompt": "Enter a new custom template name copied from built-in template",
  ...
  "detectProfileHint": "Optional autodetect scoring rules for this custom profile.",
  ...
  "labelHooks": "hooks",
  "profileHooksHint": "Declarative lifecycle hooks. Mode options come from the prompts states in this profile.",
  ...
  "hookUnsupportedOperationHint": "This operation type is preserved but cannot be edited in the form yet.",
  ...
  "textfsmPlatformPlaceholder": "TextFSM platform override, e.g. cisco_ios",
  ...
  "txBlockTemplateContentPlaceholder": "{\"name\":\"tx-block\",\"rollback_policy\":\"none\",\"steps\":[{\"run\":{\"kind\":\"command\",\"mode\":\"User\",\"command\":\"show version\",\"timeout\":30},\"rollback\":null,\"rollback_on_failure\":false}],\"fail_fast\":true}",
  "txWorkflowTemplateContentPlaceholder": "{\"name\":\"fw-policy-publish\",\"blocks\":[],\"fail_fast\":true}",
  "orchestrationTemplateContentPlaceholder": "{\"name\":\"campus-rollout\",\"stages\":[{\"name\":\"phase-1\",\"strategy\":\"parallel\",\"jobs\":[]}]}",
  ...
  "flowTemplateViewPickerPlaceholder": "search/select command flow template name",
  "flowTemplateContentPlaceholder": "Command flow template TOML",
  "flowTemplateManageHint": "The template name above is used during execution. Load a saved command flow template to edit its TOML, or save the editor content as a reusable template.",
  ...
  "flowTemplateNameRequired": "command flow template name or inline content is required",
