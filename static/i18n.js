const i18n = {
  en: {
    ...
    txBlockTemplateRunHint:
      "Select a saved template to auto-fill editor, then execute or save updates.",
  ...
  zh: {
    ...
    txBlockTemplateRunHint: "选择模板后会自动填充编辑表单，可直接执行或保存更新。",
    txBlockTemplateVarsPlaceholder:
