...
pub fn canonical_builtin_profile_name(name: &str) -> Option<&'static str> {
    match name.to_lowercase().as_str() {
        "cisco" | "ios" | "cisco_ios" => Some("cisco_ios"),
        "cisco_xe" | "iosxe" | "cisco_iosxe" => Some("cisco_xe"),
        "huawei" | "vrp" | "huawei_vrp" => Some("huawei"),
        "h3c" | "comware" | "h3c_comware" => Some("h3c_comware"),
        ...
        "paloalto" | "palo-alto" | "panos" | "paloalto_panos" => Some("paloalto_panos"),
        "topsec" => Some("topsec"),
        ...
        "maipu" => Some("maipu"),
        "checkpoint" | "check-point" | "check_point" | "checkpoint_gaia" => Some("checkpoint_gaia"),
        "ruijie" | "ruijie_os" => Some("ruijie_os"),
        "zte" | "zxros" | "zte_zxros" => Some("zte_zxros"),
        "dell" | "os10" | "dell_os10" => Some("dell_os10"),
        "aruba" | "aoscx" | "aruba_aoscx" => Some("aruba_aoscx"),
        "cisco_asa" => Some("cisco_asa"),
        "cisco_nxos" | "nxos" => Some("cisco_nxos"),
        _ => None,
    }
}
