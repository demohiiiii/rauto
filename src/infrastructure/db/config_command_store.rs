...
use crate::infrastructure::db::{command_blacklist, profile};
use anyhow::{Result, anyhow};
use regex::Regex;
use sqlx::Row;
use std::time::{SystemTime, UNIX_EPOCH};

pub use crate::domain::device::{ConfigCommandOverride, VolatilePatternOverride};
...
fn normalize_profile(profile: &str) -> Result<String> {
    ...
    Ok(profile::canonical_profile_name(profile))
}
