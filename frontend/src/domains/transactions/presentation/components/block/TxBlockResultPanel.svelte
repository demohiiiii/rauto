<script lang="ts">
  ...
  import TxOperationStepCard from "$domains/transactions/presentation/components/shared/TxOperationStepCard.svelte";
  import TxStepResultDetail from "$domains/transactions/presentation/components/shared/TxStepResultDetail.svelte";
