<script lang="ts">
  ...
  import TxWorkflowTemplateRefSourceEditor from "$domains/transactions/presentation/components/workflow/TxWorkflowTemplateRefSourceEditor.svelte";
  import TxWorkflowTemplateRefVarsEditor from "$domains/transactions/presentation/components/workflow/TxWorkflowTemplateRefVarsEditor.svelte";
  import type {
