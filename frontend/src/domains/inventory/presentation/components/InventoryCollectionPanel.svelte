<script lang="ts">
  ...
  import { inventoryCollectionActionHandlers } from "../../model/inventory.js";
  import type { InventoryCollectionDisplay } from "../inventoryPresentation.js";
  ...
  interface InventoryCollectionPanelProps {
    ...
    onHostSelection: (name: string, checked: boolean) => void;
    onSave: () => Promise<void>;
