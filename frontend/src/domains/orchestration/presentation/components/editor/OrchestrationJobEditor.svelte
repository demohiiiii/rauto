<script lang="ts">
  ...
  import { createOrchestrationJobEditorWorkspace } from "$domains/orchestration/index.js";
  import { Button } from "$lib/components/ui/button/index.js";
  import { t } from "$lib/i18n.js";
  import OrchestrationJobActionEditor from "$domains/orchestration/presentation/components/editor/OrchestrationJobActionEditor.svelte";
  import OrchestrationJobSettingsEditor from "$domains/orchestration/presentation/components/editor/OrchestrationJobSettingsEditor.svelte";
  import OrchestrationJobTargetsSection from "$domains/orchestration/presentation/components/editor/OrchestrationJobTargetsSection.svelte";
  import type {
