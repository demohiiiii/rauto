<script lang="ts">
  ...
  import OrchestrationTxWorkflowActionSettingsEditor from "$domains/orchestration/presentation/components/editor/OrchestrationTxWorkflowActionSettingsEditor.svelte";
  import OrchestrationTxWorkflowSourceEditor from "$domains/orchestration/presentation/components/editor/OrchestrationTxWorkflowSourceEditor.svelte";
