<script lang="ts">
  ...
  import OrchestrationPreviewJobCard from "$domains/orchestration/presentation/components/preview/OrchestrationPreviewJobCard.svelte";
  import OrchestrationPreviewTargetChips from "$domains/orchestration/presentation/components/preview/OrchestrationPreviewTargetChips.svelte";
