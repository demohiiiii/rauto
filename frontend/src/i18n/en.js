export const i18nEn = {
  ...
  txStageHintWorkflow:
    "Step 2: combine multiple blocks and execute a workflow.",
  ...
  txWorkflowEditorBridgeLoaded:
    "workflow block loaded into the tx block editor",
  txWorkflowEditorBridgeApplied:
    "workflow block updated from the tx block editor",
  txWorkflowEditorBridgeNoTarget:
    "select a workflow block above to start editing",
  ...
  txWorkflowBlockTemplateNameRequired:
    "tx workflow block template name is required",
  ...
  txWorkflowRollbackEmptyHint:
    "enter commands above to edit per-command rollbacks",
  ...
  textfsmTemplateMgrTitle: "Custom TextFSM Templates",
  textfsmMappingMgrTitle: "Profile Command Mappings",
  textfsmTemplateSelectPlaceholder: "Select TextFSM template",
  textfsmTemplateContentPlaceholder: "TextFSM template content",
  textfsmMappingProfilePlaceholder: "Device profile, e.g. my_custom_profile",
  ...
  showObjectCustomMgrTitle: "Custom Show Objects",
  showObjectCustomProfilePlaceholder: "Device profile, e.g. cisco_ios",
  ...
  showRefreshObjectsBtn: "Refresh Objects",
  ...
  txCommandsRequired:
    "tx commands are required (or choose a tx block template)",
