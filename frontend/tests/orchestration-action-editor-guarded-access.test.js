...
const files = [
  "OrchestrationTxBlockActionEditor.svelte",
  "OrchestrationTxBlockDirectActionEditor.svelte",
  "OrchestrationTxBlockFlowActionEditor.svelte",
  "OrchestrationTxBlockTemplateActionEditor.svelte",
  "OrchestrationTxWorkflowActionEditor.svelte",
];
